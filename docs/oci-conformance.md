...
| Linux namespaces and ID mappings | Yes | Initial relationship and range rules | Bootstrap slice creates new UTS, mount, IPC, network, and cgroup namespaces; PID/user/time creation, joins, and ID mappings remain rejected | No |
