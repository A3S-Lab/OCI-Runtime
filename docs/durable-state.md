...
create/state/start/kill/delete/wait/exec/signal-process/wait-process/pause/resume
matrix
already reopens the durable host around a new authenticated connection and
driver at all nine request/response stages for each operation, retaining 99
