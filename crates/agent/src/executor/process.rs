...
use super::restore::{LinuxRestoreSpawnRequest, LinuxRestoreSpawner, RestoreRootfsMount};
use super::restore_cgroup_namespace;
use super::restore_supervisor;
...
impl PreparedProcess {
    ...
    pub(super) async fn restore(
        ...
        cgroup_manager: Option<&CgroupManager>,
        hook_state: &HookStateTemplate,
        external_mounts: Vec<super::restore::RestoreExternalMount>,
