...
pub use oci_smoke::{
    ...
    oci_vm_reopen_replacement, oci_vm_reopen_replacement_at, oci_vm_resume_reopen_replacement_at,
    oci_vm_signal_process_reopen_replacement_at, oci_vm_smoke, oci_vm_start_reopen_replacement_at,
    oci_vm_state_reopen_replacement_at, oci_vm_stats_reopen_replacement_at,
    oci_vm_transport_fault_cleanup, oci_vm_update_reopen_replacement_at,
    oci_vm_wait_process_reopen_replacement_at, oci_vm_wait_reopen_replacement_at,
    oci_vm_write_stdin_reopen_replacement_at, windows_oci_vm_multi_container_smoke,
};
