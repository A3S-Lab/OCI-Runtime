...
enum Command {
    ...
    /// Qualify all Host/Guest Stats interruption stages through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    ...
    LinuxKvmStatsReopen {
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side Stats transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
    /// Qualify all Host/Guest ReadOutput interruptions through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    #[command(hide = true)]
    LinuxKvmReadOutputReopen {
        /// Absolute isolated libkrun shim executable.
        #[arg(long, value_name = "FILE")]
        shim: PathBuf,
        /// New or empty private root for durable state, shares, and consoles.
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side ReadOutput transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
    /// Qualify all Host/Guest WriteStdin interruptions through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    #[command(hide = true)]
    LinuxKvmWriteStdinReopen {
        /// Absolute isolated libkrun shim executable.
        #[arg(long, value_name = "FILE")]
        shim: PathBuf,
        /// New or empty private root for durable state, shares, and consoles.
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side WriteStdin transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
    /// Qualify all Host/Guest CloseStdin interruptions through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    #[command(hide = true)]
    LinuxKvmCloseStdinReopen {
        /// Absolute isolated libkrun shim executable.
        #[arg(long, value_name = "FILE")]
        shim: PathBuf,
        /// New or empty private root for durable state, shares, and consoles.
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side CloseStdin transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
    ...
    /// Qualify all Host/Guest File interruptions through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    ...
    LinuxKvmFileReopen {
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side File transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
    /// Qualify all Host/Guest Filesystem interruptions through real KVM owners.
    #[cfg(all(
        target_os = "linux",
        any(target_arch = "x86_64", target_arch = "aarch64")
    ))]
    #[command(hide = true)]
    LinuxKvmFilesystemReopen {
        /// Absolute isolated libkrun shim executable.
        #[arg(long, value_name = "FILE")]
        shim: PathBuf,
        /// New or empty private root for durable state, shares, and consoles.
        ...
        #[arg(long, value_name = "DIR")]
        bundle: PathBuf,
        /// Exact Host- or Guest-side Filesystem transition to interrupt.
        #[arg(long, value_enum)]
        fault_at: reopen_replacement::FaultStageArg,
    },
