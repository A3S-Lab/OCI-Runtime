...
const NON_SEMANTIC_RULES: &[OciNonSemanticRule] = &[
    ...
    OciNonSemanticRule::new(
        "oci.common.mount.destination.root-relative",
        "linux-executor",
    ),
    ...
    OciNonSemanticRule::new("oci.common.process.environment.exact", "linux-executor"),
    OciNonSemanticRule::new("oci.common.process.no-new-privileges", "linux-executor"),
    OciNonSemanticRule::new(
        "oci.common.process.supplementary-groups.exact",
        "linux-executor",
    ),
    OciNonSemanticRule::new("oci.common.process.terminal.default", "linux-executor"),
    OciNonSemanticRule::new("oci.common.process.umask.exact", "linux-executor"),
    ...
    OciNonSemanticRule::new("oci.linux.namespace.create-join-inherit", "linux-executor"),
    OciNonSemanticRule::new("oci.linux.namespace.join.exact", "linux-executor"),
    OciNonSemanticRule::new("oci.linux.namespace.join.type-checked", "linux-executor"),
    OciNonSemanticRule::new("oci.linux.namespace.supported-types", "linux-executor"),
    OciNonSemanticRule::new("oci.linux.namespace.type.required", "linux-executor"),
    ...
    OciNonSemanticRule::new("oci.linux.seccomp.policy.enforced", "linux-executor"),
    OciNonSemanticRule::new(
        "oci.linux.seccomp.unsupported-controls.rejected",
        "linux-executor",
    ),
    OciNonSemanticRule::new("oci.linux.seccomp.notification.rejected", "linux-executor"),
    ...
    OciNonSemanticRule::new(
        "oci.runtime.container.same-entity-operations",
        "runtime-lifecycle",
    ),
    ...
    OciNonSemanticRule::new(
        "oci.runtime.delete.external-resources-preserved",
        "linux-executor",
    ),
    OciNonSemanticRule::new("oci.runtime.delete.id.required", "sdk-transport"),
    OciNonSemanticRule::new("oci.runtime.delete.id.reusable", "runtime-lifecycle"),
    OciNonSemanticRule::new("oci.runtime.delete.owned-resources", "linux-executor"),
    ...
    OciNonSemanticRule::new("oci.runtime.query-state.exact-state", "runtime-lifecycle"),
    OciNonSemanticRule::new("oci.runtime.query-state.id.required", "sdk-transport"),
