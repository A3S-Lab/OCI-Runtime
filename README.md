...
| macOS arm64/HVF | Real HVF object lifecycle, pinned libkrun context and guest entry, protocol-v9 agent, fixed and multi-container lifecycle, descriptor-confined filesystem sessions, mount/namespace profiles, no-delete cleanup, all nine Host/Guest Create transport stages, both Host shutdown stages, and 25 fresh-VM waves | `probe-only`; immutable system image, host-service-reopen and VM-owner-replacement fault matrices, and release hardware qualification remain |
