...
| Validation and transport | OCI 1.0.0–1.3.0 schema and semantic validation with forward-compatible unknown-property retention and ignore semantics, immutable configuration and attachment SHA-256 binding, and bounded protocol-4 local IPC over Unix sockets or protected Windows named pipes |
...
| Owner-bound non-semantic rules | 108 |
| OCI normative dispositions | 454 enforced · 51 validated · 2 conformant · 148 pending review |
