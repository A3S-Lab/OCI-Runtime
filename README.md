...
a usable InfiniBand device. Arbitrary `linux.resources.unified` writes remain
unsupported because they bypass the typed resource ownership boundary.
...
| Owner-bound non-semantic rules | 121 |
| OCI normative dispositions | 490 enforced · 50 validated · 2 conformant · 113 pending review |
