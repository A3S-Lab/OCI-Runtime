...
gate plus private-PID- and configured-network-namespace negative gates.
Driver-local cross-process restore replay, broader namespace and descriptor
profiles, published-package execution, multi-architecture qualification, and
production readiness remain open. See
...
- Native Linux CRIU driver-local cross-process restore replay, broader
  checkpoint source profiles, published-package and multi-architecture
  real-host qualification, and production checkpoint/restore readiness;
