...
workload recovery or driver Delete before Host replay. Equivalent coverage for
the other 15 workload operations and Host shutdown remains an explicit
readiness gate.
