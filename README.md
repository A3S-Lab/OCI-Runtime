...
inventories. Equivalent coverage for the other 18 workload operations and
...
| Linux KVM State operation-stage owner replacement | Implemented and CI-wired for both architectures; retained clean-host evidence is pending, so implemented coverage is 18 / 180 workload-operation paths while retained evidence remains 9 / 180 |
