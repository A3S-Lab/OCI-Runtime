...
`a3s.oci.linux-kvm-lifecycle-matrix.v1` report
...
skips Alpine on an unavailable host; on KVM it runs 25 fresh generations and
...
KVM hosts, followed by the remaining negative-isolation profiles.
