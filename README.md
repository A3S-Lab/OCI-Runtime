...
workload, and restores all inventories. Equivalent coverage for the other 13
workload operations and Host shutdown remains an explicit readiness gate.
