...
gate stops the Host until schema-v9 metadata retains exec incarnation 1,
...
ttrpc endpoint and schema-v9 metadata retains exec incarnation 1, stdin state
