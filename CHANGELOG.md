...
- OCI Linux NUMA memory-policy enforcement for configured init. One SDK
  ...
  HVF and WHPX fixtures verify `MPOL_BIND` on node 0 from inside the workload.
  Nine requirements move to enforced, leaving 247 enforced, 25 validated, two
  conformant, and 381 pending entries.
